          ...
          {registered ? (
            ...
            <>
              <div className="flex flex-col items-center mb-6">
                <div className="w-20 h-20 rounded-full bg-green-500 flex items-center justify-center shadow-xl mb-4">
                  <FaCheckCircle className="text-white text-4xl" />
                </div>
                <h1 className="text-3xl font-bold text-white text-center">Check Your Email</h1>
                <p className="text-slate-300 mt-4 text-center leading-relaxed">
                  We sent a verification link to <strong className="text-cyan-400">{formData.email}</strong>.
                  ...
                  <button
                    onClick={async () => {
                      try {
                        ...
                        toast.error("Failed to resend. Check spam folder.");
                      }
                    }}
